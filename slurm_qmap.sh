...
#SBATCH -o LOG_qmap-%A_%a.out # Standard output - write the console output to the output folder %A= Job ID, %a = task or Step ID
#SBATCH -e LOG_qmap-%A_%a.err # Standard error -write errors to the errors folder and

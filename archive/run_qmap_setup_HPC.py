...
nc_standard_clim = raw_dir + \
    '/aresult/ICHEC-EC-EARTH_rcp85_r12i1p1_CLMcom-CCLM5-0-6_v1__TS.nc_TS_ALL_ll.nc'
nc_standard_hist = raw_dir + \
    '/aresult/ICHEC-EC-EARTH_historical_r1i1p1_KNMI-RACMO22E_v1__TS.nc_TS_ALL_ll.nc'  # exists?
...
Parallel(
    n_jobs=int(num_cores))(
        delayed(
            run_qmap_HPC.main)(
                root,
            tscale_file) for tscale_file in tscale_files_sort)
